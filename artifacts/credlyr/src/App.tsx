      ...
      >
        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between gap-5 mt-16 w-full flex-wrap border-t border-white/10 pt-8">
            ...
            {/* AI Summary Section with icons matching Duna */}
            <div className="flex items-center gap-3">
              <span className="text-[12px] text-white/80 font-medium">Get an AI summary of Duna:</span>
              <div className="flex items-center gap-2.5">
                {/* Claude icon link */}
                <a
                  href="#"
                  ...
                  title="Claude"
                  aria-label="Get Claude AI summary of Duna"
                >
                ...
                <a
                  ...
                  className="text-white/80 hover:text-white transition-colors"
                  title="ChatGPT"
                  aria-label="Get ChatGPT AI summary of Duna"
                >
                  <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a
                  ...
                  className="text-white/80 hover:text-white transition-colors"
                  title="Gemini"
                  aria-label="Get Gemini AI summary of Duna"
                >
                  <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
